...
// 5. Create attendance_history table (permanent daily records)
...
if ($conn->query($sql)) {
    $results[] = '✅ Table <strong>attendance_history</strong> created (or already exists)';
} else {
    $results[] = '❌ Failed to create attendance_history: ' . $conn->error;
}
